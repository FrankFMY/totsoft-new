    ...
    <div class="prose prose-invert max-w-none space-y-8">
      ...
      <section class="bg-dark-800 rounded-2xl p-8 border border-white/10">
        ...
        <div class="text-slate-300 space-y-2">
          <p>
            <strong class="text-white">Организация:</strong> {COMPANY_INFO.name}
          </p>
          <p>
            <strong class="text-white">ИНН:</strong> {COMPANY_INFO.inn}
          </p>
          <p>
            <strong class="text-white">КПП:</strong> {COMPANY_INFO.kpp}
          </p>
          <p>
            <strong class="text-white">ОГРН:</strong> {COMPANY_INFO.ogrn.number}
          </p>
          <p>
